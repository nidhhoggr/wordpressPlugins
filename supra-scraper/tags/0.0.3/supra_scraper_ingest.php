...
$randomize = array('is'=>null,'min_int'=>null,'max_int'=>null); 
...
-->
        ...
        <p id="storepostmeta">
            <span id="storepostmeta_tt" class="tooltip"></span>Store Post Meta: <input type="checkbox" name="sscrap_storemeta" value="true" <?php echo ($sscrapingest['storemeta'])?'checked="checked"':''?>>
        </p>
...
<div style="float: right; width: 300px;">
        ...
        <p id="ingestion_debugging">
            <span id="debugingestion_tt" class="tooltip"></span>Debug Ingestion: <input type="checkbox" name="sscrap_ingest_debugger" value="true" <?php echo ($ingest_debugger)?'checked="checked"':''?>>
        </p>
        ...
        <p><span id="targetupdate_tt" class="tooltip"></span>Update Existing Posts
            <input type="checkbox" name="sscrap_targetupdate" value="true"></p>
        </div>
        <h3>Go Premium</h3>
        <p>
            Take advantage of premium features such as using custom post types
            <a href="http://www.supraliminalsolutions.com/blog/listings/supra-scraper/" target="_blank">upgrade here!</a>
        </p>
        <hr />
        <p>
