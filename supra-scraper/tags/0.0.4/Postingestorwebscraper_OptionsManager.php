...
class Postingestorwebscraper_OptionsManager {
    ...
    public function settingsPage() {
        if (!current_user_can('manage_options')) {
            wp_die(__('You do not have sufficient permissions to access this page.', 'postingestorwebscraper'));
        }
        ...
        ?>
        <div class="wrap">
            <h2><?php _e('System Settings', 'postingestorwebscraper'); ?></h2>
            <table class="form-table"><tbody>
            <tr><td><?php _e('System', 'postingestorwebscraper'); ?></td><td><?php echo php_uname(); ?></td></tr>
            <tr><td><?php _e('PHP Version', 'postingestorwebscraper'); ?></td>
                <td><?php echo phpversion(); ?>
                <?php
                if (version_compare('5.2', phpversion()) > 0) {
                    echo '&nbsp;&nbsp;&nbsp;<span style="background-color: #ffcc00;">';
                    _e('(WARNING: This plugin may not work properly with versions earlier than PHP 5.2)', 'postingestorwebscraper');
                    echo '</span>';
                }
                ?>
                </td>
            </tr>
            <tr><td><?php _e('MySQL Version', 'postingestorwebscraper'); ?></td>
                <td><?php echo $this->getMySqlVersion() ?>
                    <?php
                    echo '&nbsp;&nbsp;&nbsp;<span style="background-color: #ffcc00;">';
                    if (version_compare('5.0', $this->getMySqlVersion()) > 0) {
                        _e('(WARNING: This plugin may not work properly with versions earlier than MySQL 5.0)', 'postingestorwebscraper');
                    }
                    echo '</span>';
                    ?>
                </td>
            ...
            <h2><?php echo $this->getPluginDisplayName(); echo ' '; _e('Settings', 'postingestorwebscraper'); ?></h2>
            ...
            <?php settings_fields($settingsGroup); ?>
                ...
                <p class="submit">
                    <input type="submit" class="button-primary"
                           value="<?php _e('Save Changes', 'postingestorwebscraper') ?>"/>
                </p>
            </form>
        </div>
        <?php
    ...
    protected function getOptionValueI18nString($optionValue) {
        switch ($optionValue) {
            case 'true':
                return __('true', 'postingestorwebscraper');
            case 'false':
                return __('false', 'postingestorwebscraper');

            case 'Administrator':
                return __('Administrator', 'postingestorwebscraper');
            case 'Editor':
                return __('Editor', 'postingestorwebscraper');
            case 'Author':
                return __('Author', 'postingestorwebscraper');
            case 'Contributor':
                return __('Contributor', 'postingestorwebscraper');
            case 'Subscriber':
                return __('Subscriber', 'postingestorwebscraper');
            case 'Anyone':
                return __('Anyone', 'postingestorwebscraper');
        }
        return $optionValue;
    }
